...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('revolink', REVOLINK_URL . 'assets/revolink.css', [], REVOLINK_VERSION);
});
        ...
        '@graph'   => [
            ...
            [
                ...
                'mainEntity' => [
                    ...
                    [
                        '@type' => 'Question',
                        'name'  => 'スポンサーになるにはどんなサイトが必要ですか？',
                        'acceptedAnswer' => ['@type' => 'Answer', 'text' => '病院・クリニック、法律事務所・税理士事務所、企業・法人サイト、店舗・飲食店、個人ブログ、里親カフェのHP、SNSリンクページ（Linktree等）、noteなど、発信の場であればほぼどこでも参加可能です。審査は不要です。'],
                    ],
                    [
                        '@type' => 'Question',
                        'name'  => '社会貢献型広告収入スポンサープログラムとは何ですか？',
                        'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'ホームページを運用して応援の輪へとつなげ、広告運用から生まれた収益の一部をおのくんの活動に還元する仕組みです。補助金に頼らない持続可能な社会貢献の形を目指しています。'],
                    ],
                ],
            ],
        ...
        <div style="max-width:1040px;margin:0 auto;">
            ...
            <div style="text-align:center;background:rgba(251,146,60,0.1);border:2px solid rgba(251,146,60,0.3);border-radius:24px;padding:48px 40px;">
                ...
                <div style="margin-bottom:28px;padding:24px 28px;background:rgba(255,255,255,0.04);border-radius:14px;border-left:3px solid #fb923c;">
                    <p style="font-size:15px;color:#cbd5e1;line-height:1.8;margin:0;">ホームページを運用して、応援の輪へとつなげ、広告運用から生まれた収益の一部を、社会貢献型広告収入スポンサープログラムで、日常の活動を社会貢献型に変え、補助金に頼らない、持続可能な応援の形を目指します。</p>
                </div>
